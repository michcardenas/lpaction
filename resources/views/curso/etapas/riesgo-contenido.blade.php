...
<div class="riesgo">
    ...
    <p class="prueba-p riesgo-p">
        ...
        determinación de Lp(a). El porcentaje de pacientes con SCA en quienes se determina la Lp(a) es muy bajo, generalmente
        &lt;2% en la práctica clínica real, a pesar de que las guías internacionales recomiendan su medición en este grupo de
        alto riesgo2. Estudios recientes en redes de atención primaria y cardiología muestran que solo el 1,55% de los
