{{-- Contenido de la etapa "Presentación del caso" — INGRESO 1 (textos editables desde el panel) --}}
...
<div class="content-col">
    ...
    <div class="perfil-card">
        ...
        <div class="tab-panel" data-panel="historia" style="display:none">
            <p>{{ cms($k.'historia_p', 'Hipertensión arterial (HTA) ligera de 7 años de evolución.') }}</p>
        </div>
