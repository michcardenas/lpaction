...
<head>
    ...
    <title>Tutoría — Lp(a)ction</title>
    ...
    <style>
        ...
        .tut-label {
            display: block; font-family: 'Montserrat', sans-serif; font-weight: 500; font-size: 15px;
            line-height: 150%; color: #FFFFFF; margin-bottom: 10px;
        }
        .tut-textarea {
            display: block; width: 100%; min-height: 180px; resize: vertical;
        ...
        .tut-textarea::placeholder { color: #9aa3ab; }
        .tut-textarea:focus { outline: none; border-color: #05BAEE; }
        .tut-submit {
        ...
        .tut-submit:hover { background: #04a3d1; }
...
<body class="tut-bg curso-bg min-h-screen flex flex-col text-white">
        ...
        <div class="mx-auto px-6 lg:px-12 h-16 flex items-center justify-between" style="max-width:1600px;">
            <div class="flex items-center" style="gap:30px;">
                ...
                <nav class="hidden md:flex items-center" style="gap:8px;">
                    ...
                    <a href="{{ route('tutoria') }}" class="nav-link active">Tutoría</a>
    ...
    <main class="flex-1">
        <div class="tut-wrap">
            ...
            {{-- Título --}}
            <h1 class="tut-title">Tutoría</h1>
            <div class="tut-title-underline"></div>

            {{-- Card glass: Formulario de contacto --}}
            <div class="tut-card">
                <h2 class="tut-card-head">Formulario de contacto</h2>

                {{-- Envío pendiente: el cliente aún no ha definido la configuración del botón "Enviar" --}}
                <form onsubmit="return false">
                    <label class="tut-label" for="tut-motivo">Motivo de contacto <span style="color:#e5484d">*</span></label>
                    <textarea id="tut-motivo" class="tut-textarea" placeholder="Escribe aquí..."></textarea>

                    {{-- Envío pendiente: el cliente aún no ha definido la configuración del botón "Enviar" --}}
                    <button type="button" class="tut-submit">Enviar</button>
                </form>
            </div>
